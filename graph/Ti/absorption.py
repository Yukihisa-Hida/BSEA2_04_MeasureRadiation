...
input_csv = pd.read_csv("C:\\uec\\基礎科学実験A\\04\\BSEA1_04_MeasureRadiation\\graph\\Ti\\absorption-Ti.csv", header=None)
...
plt.xlabel(r"$\mathrm{Ti}$箔の厚さ$\ x_\mathrm{Ti}/\mathrm{mm}$")
