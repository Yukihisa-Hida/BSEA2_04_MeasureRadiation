...
図\ref{fg:count-distribution-100mm-300times},\ref{fg:count-distribution-60mm-300times},\ref{fg:count-distribution-30mm-300times}より, 計数管と線源の距離が近づくほど計数値の平均値$\overline{N}$は大きくなっていることがわかる.
