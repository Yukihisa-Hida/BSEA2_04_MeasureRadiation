...
\begin{figure}[H]
  \begin{center}
    \includegraphics[width=90mm]{graph/count-distribution-100mm-20times.png}
    \caption{自然計数の分布}
...
\begin{figure}[H]
  \begin{center}
    \includegraphics[width=90mm]{graph/count-distribution-100mm-100times.png}
...
\begin{figure}[H]
  \begin{center}
    \includegraphics[width=90mm]{graph/count-distribution-100mm-300times.png}
    \caption{計数値の分布（●はポアソン分布）}
...
\begin{figure}[H]
  \begin{center}
    \includegraphics[width=90mm]{graph/count-distribution-60mm-300times.png}
    \caption{計数値の分布（●はポアソン分布）}
...
\begin{figure}[H]
  \begin{center}
    \includegraphics[width=90mm]{graph/count-distribution-30mm-300times.png}
    \caption{計数値の分布（●はポアソン分布）}
